...
(function () {
  ...
  function setBurger(open) {
    ...
    var ico = burger.querySelector('i');
    if (ico) {
      ico.classList.toggle('fa-bars', !open);
      ico.classList.toggle('fa-xmark', open);
    }
    burger.setAttribute('aria-expanded', open ? 'true' : 'false');
    document.body.classList.toggle('nav-open', open);
    if (!open && servicesDropRef) {
      servicesDropRef.classList.remove('open');
      if (servicesToggleRef) servicesToggleRef.setAttribute('aria-expanded', 'false');
    }
  }

  var servicesToggleRef = document.getElementById('servicesToggle');
  var servicesDropRef = document.getElementById('servicesDrop');
